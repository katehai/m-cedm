# The file is downloaded from the pull request:
# https://github.com/clawpack/riemann/pull/109/files#diff-2b88af5cdeacdb05f65a16f7d271cefcdf483b344462988803cfd63805cde46d
# Roe solver with e-fix as well as HLL solver produce the same results as their Fortran counterparts.
# The original file for the Riemann solvers for shallow water equation are located in
# https://github.com/clawpack/riemann/blob/master/riemann/shallow_1D_py.py
r"""
...
def shallow_roe_1D(q_l, q_r, aux_l, aux_r, problem_data):
    ...
    *problem_data* should contain:
    ...
    """
    ## Fortran implementation is available here
    ## https://github.com/clawpack/riemann/blob/master/src/rp1_shallow_roe_with_efix.f90
    # Array shapes
    num_rp = q_l.shape[1]
...
def shallow_exact_1D(q_l, q_r, aux_l, aux_r, problem_data):
    r"""
    Exact shallow water Riemann solver, used for dataset simulation in the paper

    """
    # print("Run exact riemann solver")
    num_eq = 2
    num_waves = 2
